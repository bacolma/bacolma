   ...
   <div class="container" style="font-family: 'Montserrat', sans-serif;"> 
     <div class="card mb-4 shadow-sm" style="border-radius: 20px;">
            <div class="card-header" style="background-color: #009bdb;color:#fff;border-radius: 20px;">
                <h4 class="my-0 fw-normal">MODIFICACION PEDIDO</h4>
            </div>
            <div class="card-body" style="border-radius: 20px;">
                    ...
                    <?php include_once("msg.php");
                     ...
                     $result= $db->get_query($qr->getPedidosFind($id));
                   ...
                   if($result->num_rows > 0) {
                    ...
                    <table class="table">
                        <tr>
                            <td>Cliente:</td>
                            <td><input type='text' id='cliente' name='cliente' class='form-control' readonly></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>Serie:</td>
                            <td><input type='text' id='serie' name='serie' class='form-control' value="<?php echo $row['serie']?>"></td>
                        </tr>
                        <tr>
                            <td>Guia:</td>
                            <td><input type='text' id='guia' name='guia' class='form-control' value="<?php echo $row['guia']?>"></td>
                        </tr>
                        <tr>
                            <td>Codigo:</td>
                            <td><input type='text' id='codigo' name='codigo' class='form-control' value="<?php echo $row['codigo']?>"></td>
                        </tr>
                        <tr>
                            <td>Origen:</td>
                        ...
                        <tr>
                            <td>Descripcion:</td>
                            <td><textarea id="descripcion" name="descripcion" class='form-control'><?php echo $row["descripcion"]; ?></textarea></td>
                        </tr>       
                        <tr>
                            <td colspan="2">
